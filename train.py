    ...
    def run(self):
        ...
        try:
            ...
            for i in range(self.game_batch_num):                
                ...
                if (i+1) % self.check_freq == 0 or save == 1:
                    print("current self-play batch: {}".format(i+1))
                    count += self.check_freq
                    ...
                    if count == 1000 or save == 1:
                        ...
                        if win_ratio > self.best_win_ratio:
                            ...
                            pickle.dump(net_params, open('best_policy_15_15_5.model', 'wb'), pickle.HIGHEST_PROTOCOL) # update the best_policy
